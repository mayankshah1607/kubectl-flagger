...
var rollbackCmd = &cobra.Command{
	Use:   "rollback [canary name] [canary namespace]",
	Short: "Rollback a Canary deployment to the previous version",
	Long:  "Rollback a Canary deployment to the previous version",
